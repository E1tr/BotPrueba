...
@bot.command()
async def paja(ctx):
    user = await ctx.guild.fetch_member(610522653161160744)  # ID de usuario
    await ctx.send('¡Pajearse es de pobres!')
    await ctx.send(f'¡na mentira! Mejor correrse en la cara de: {user.mention} 🥛')
